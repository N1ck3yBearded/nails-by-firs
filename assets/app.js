...
(function(){
  const DICT = {
    ru: {
      ...
      'cin.sub':'Стандарт Unguis House · Ричмонд-Хилл, Торонто',
    ...
    es: {
      ...
      'phil.quote':'«Un acabado perfecto es, simplemente, el cuidado hecho visible.»','phil.founder':'Mary — Fundadora y maestra artista',
      'stat.1l':'Años de práctica','stat.2l':'Citas','stat.3l':'Herramientas de un solo uso','stat.4l':'Idiomas',
      'cin.sub':'El estándar Unguis House · Richmond Hill, Toronto',
