...
(function(){
  const DICT = {
    ru: {
      'nav.philosophy':'Философия','nav.services':'Услуги','nav.standards':'Стандарты','nav.finishes':'Финиши','nav.work':'Работы','nav.journal':'Журнал','nav.reserve':'Запись','nav.book':'Записаться',
      'hero.eyebrow':'Nail Care · Ричмонд-Хилл, Торонто',
      'hero.h1a':'Высокая красота,','hero.h1b':'созданная с','hero.h1c':'<em>вечнозелёной</em> заботой.',
      ...
      'hero.cta1':'Записаться на визит','hero.cta2':'Познакомиться с Nails by Firs',
      ...
      'phil.eyebrow':'Философия Firs',
      'phil.h2':'Красота начинается там, где забота <em>бескомпромиссна.</em>',
      'phil.p1':'Firs — это ель, вечнозелёное дерево, неизменное в любое время года. Это наше имя — и наш стандарт. Каждый визит идёт в темпе точности: инструменты стерилизуются по клиническому протоколу, средства выбираются сначала ради здоровья ногтей и лишь затем ради цвета.',
      ...
      'phil.quote':'«Идеальный финиш — это просто забота, ставшая видимой.»','phil.founder':'Мария Фирс — основатель и мастер',
      'stat.1l':'Лет практики','stat.2l':'Визитов','stat.3l':'Одноразовые инструменты','stat.4l':'Языка общения',
      'cin.sub':'Вечнозелёный стандарт · Ричмонд-Хилл, Торонто',
      ...
      'jr.eyebrow':'Журнал Firs','jr.h2':'Уход, записанный <em>словами.</em>','jr.lead':'Заметки о здоровье ногтей, гигиене и тихом цвете — от нашего стола к вашему.','jr.cta':'Читать журнал','jr.min':'мин чтения',
      ...
      'vox.q1':'«Самый чистый и спокойный визит за маникюром в моей жизни. Стандарт чувствуется в каждой мелочи.»','vox.w1':'Елена · Ричмонд-Хилл',
      ...
      'res.eyebrow':'Запись на визит','res.h2':'Ваши руки заслуживают <em>вечнозелёного</em> стандарта.',
      'res.p':'Визиты приватны, и их число в день ограничено. Напишите нам — и мы найдём время, которое будет принадлежать только вам.',
      'res.cta1':'Записаться в Instagram','res.cta2':'Как нас найти',
      'res.n1h':'Где','res.n1':'10350 Yonge Street,<br>Ричмонд-Хилл, Онтарио',
      'res.n2h':'Когда','res.n2':'Только по записи —<br>будни и выходные',
      'res.n3h':'Как','res.n3':'Напишите в Instagram<br>@nails_by_firs',
      'foot.about':'Nail Care в Ричмонд-Хилле (Торонто): гигиена — на первом месте. Маникюр, педикюр, подология и восстановление ногтей как тихое ремесло.',
      ...
      'jr.page.eyebrow':'Журнал Firs','jr.page.h1':'Уход, записанный <em>словами.</em>','jr.page.lead':'Заметки о здоровье ногтей, гигиене и тихом цвете — от нашего стола к вашему.',
      'jr.filter.all':'Все','jr.filter.hygiene':'Гигиена','jr.filter.care':'Уход','jr.filter.trends':'Тренды',
      'art.cta.h':'Доверьте руки вечнозелёному стандарту','art.cta.p':'Визиты приватны, и их число в день ограничено. Напишите нам — и мы найдём время для вас.','art.cta.btn':'Записаться в Instagram',
      'art.author':'Студия Nails by Firs',
      'gal.viewall':'Смотреть все работы',
      'gal.page.eyebrow':'Портфолио Firs','gal.page.h1':'Каждая работа — <em>тихая</em> точность.','gal.page.lead':'Маникюр, педикюр и подология, созданные в студии. Нажмите на фото, чтобы рассмотреть ближе.',
      'gal.cat.all':'Все','gal.cat.nails':'Маникюр','gal.cat.pedi':'Педикюр','gal.cat.podo':'Подология'
    },
    es: {
      'nav.philosophy':'Filosofía','nav.services':'Servicios','nav.standards':'Estándares','nav.finishes':'Acabados','nav.work':'Trabajos','nav.journal':'Diario','nav.reserve':'Reservar','nav.book':'Reservar',
      'hero.eyebrow':'Nail Care · Richmond Hill, Toronto',
      'hero.h1a':'Belleza elevada,','hero.h1b':'practicada con','hero.h1c':'cuidado <em>siempre verde</em>.',
      ...
      'hero.cta1':'Reservar una cita','hero.cta2':'Descubrir Nails by Firs',
      ...
      'phil.eyebrow':'La filosofía Firs',
      'phil.h2':'La belleza comienza donde el cuidado es <em>intransigente.</em>',
      'phil.p1':'Firs es el abeto: siempre verde, constante en cada estación. Es nuestro nombre y nuestro estándar. Cada cita avanza al ritmo de la precisión: instrumentos esterilizados bajo protocolo clínico, productos elegidos primero por la salud de la uña y después por el color.',
      ...
      'phil.quote':'«Un acabado perfecto es, simplemente, el cuidado hecho visible.»','phil.founder':'Mary Firs — Fundadora y maestra artista',
      'stat.1l':'Años de práctica','stat.2l':'Citas','stat.3l':'Herramientas de un solo uso','stat.4l':'Idiomas',
      'cin.sub':'El estándar siempre verde · Richmond Hill, Toronto',
      ...
      'jr.eyebrow':'El diario Firs','jr.h2':'El cuidado, puesto en <em>palabras.</em>','jr.lead':'Notas sobre la salud de las uñas, la higiene y el color sereno — de nuestra mesa a la tuya.','jr.cta':'Leer el diario','jr.min':'min de lectura',
      ...
      'vox.q1':'«La cita de uñas más limpia y serena que he tenido. El estándar se siente en cada pequeño detalle.»','vox.w1':'Elena · Richmond Hill',
      'vox.q2':'«Mary reconstruyó mis uñas tras años de daño. Paciente, honesta — y los resultados hablan en voz baja por sí mismos.»','vox.w2':'Sofía · Toronto',
      ...
      'res.eyebrow':'Reserva tu cita','res.h2':'Tus manos merecen el estándar <em>siempre verde</em>.',
      'res.p':'Las citas son privadas y limitadas cada día. Escríbenos y encontraremos una hora que te pertenezca solo a ti.',
      'res.cta1':'Reservar por Instagram','res.cta2':'Cómo llegar',
      'res.n1h':'Dónde','res.n1':'10350 Yonge Street,<br>Richmond Hill, Ontario',
      ...
      'foot.about':'Nail care en Richmond Hill, Toronto, donde la higiene es lo primero. Manicura, pedicura, podología y restauración de uñas como oficios serenos.',
      ...
      'jr.page.eyebrow':'El diario Firs','jr.page.h1':'El cuidado, puesto en <em>palabras.</em>','jr.page.lead':'Notas sobre la salud de las uñas, la higiene y el color sereno — de nuestra mesa a la tuya.',
      'jr.filter.all':'Todos','jr.filter.hygiene':'Higiene','jr.filter.care':'Cuidado','jr.filter.trends':'Tendencias',
      'art.cta.h':'Confía tus manos al estándar siempre verde','art.cta.p':'Las citas son privadas y limitadas cada día. Escríbenos y encontraremos una hora para ti.','art.cta.btn':'Reservar por Instagram',
      'art.author':'Estudio Nails by Firs',
      'gal.viewall':'Ver todos los trabajos',
      'gal.page.eyebrow':'Portafolio Firs','gal.page.h1':'Cada trabajo, una precisión <em>serena</em>.','gal.page.lead':'Manicura, pedicura y podología creadas en el estudio. Toca una foto para verla de cerca.',
